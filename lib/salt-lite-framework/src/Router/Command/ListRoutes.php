...
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\CsvFormatter;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\HashFormatter;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\JsonFormatter;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\RouteDefinitionListFormatter;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\RouteDefinitionListSorter;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\SortByName;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\SortByPath;
use PhoneBurner\SaltLiteFramework\Router\Command\CommandHelper\TableFormatter;
use PhoneBurner\SaltLiteFramework\Router\Definition\DefinitionList;
use PhoneBurner\SaltLiteFramework\Router\Definition\InMemoryDefinitionList;
...
{
    public const string NAME = 'router:list';
